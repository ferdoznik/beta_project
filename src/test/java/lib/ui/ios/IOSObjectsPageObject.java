...
public class IOSObjectsPageObject extends ObjectsPageObject {
    ...
    static {
        ...
        SEARCH_HISTORY_OBJECT_CODE_TPL = "xpath://*[contains(@name,'Код объекта: {object_code}')]";
        ...
        UPPER_PARAM_FIELD = "id:\uEAB1 Квартира, Продажа, Активный, Создан 10 мая 2023 г.";
        LOWER_PARAM_FIELD = "xpath://XCUIElementTypeStaticText[@name='Тюмень, 2-й Заречный мкр, 1-ая Западная, 44, кв. 42, под. 2']']";
