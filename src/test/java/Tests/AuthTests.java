...
@Features(value = {@Feature(value = "Authorization")})
public class AuthTests extends CoreTestCase {
    ...
    public void testIncorrectLogin() {
        ...
        Auth.waitForLoginButton();
        Auth.enterLoginData("incorrect", password);
        Auth.clickLOGINButton();
        Auth.waitForLoaderToDisappear();
    ...
    public void testIncorrectPassword() {
        ...
        Auth.waitForLoginButton();
        Auth.enterLoginData(login, "incorrect");
        Auth.clickLOGINButton();
        Auth.assertWrongLoginOrPasswordSnackBarIsThere();
    }

    @Test
    //Нужен заблоченный акк
    ...
    @Test
    @DisplayName("Blocking the application during authorization")
